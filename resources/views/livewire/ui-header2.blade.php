    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="app-assets/css/core/menu/menu-types/material-vertical-content-menu.css">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="/"><img class=""  style="width:200px; " alt="modern admin logo" src="app-assets/images/logo/iusmlogo2.png">
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <li class="dropdown nav-item mega-dropdown d-none d-lg-block"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">메인메뉴</a>
    ...
    <div class="main-menu material-menu menu-static menu-light menu-accordion menu-shadow"
        ...
        <div class="user-profile">
            <div class="user-info text-center pt-1 pb-1 ml-2"><img class="user-img img-fluid rounded-circle" src="app-assets/images/portrait/small/avatar-s-4.png" />
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="/cat0"><i class="material-icons">settings_input_svideo</i>
                        <span class="menu-title" data-i18n="Dashboard">카테고리-Category</span>
                        <span class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
                    <ul class="menu-content">
                        <li class="active">
                            <a class="menu-item" href="/cat1">
                                <i class="material-icons"></i>
                                <span data-i18n="eCommerce">1차 카테고리</span></a>
                        </li>
                        <li><a class="menu-item" href="/cat2">
                                <i class="material-icons"></i>
                                <span data-i18n="Crypto">2차 카테고리</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="material-icons">tv</i><span class="menu-title" data-i18n="Templates">신문 기사</span></a>
                    <ul class="menu-content">
                ...
                <li class=" navigation-header">
                    <span data-i18n="Admin Panels">관리자 패널</span>
                    <i class="material-icons nav-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="Admin Panels">more_horiz</i>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="material-icons">code</i><span class="menu-title" data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-1-column.html"><i class="material-icons"></i><span data-i18n="1 column">1 column</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-2-columns.html"><i class="material-icons"></i><span data-i18n="2 columns">2 columns</span></a>
                        </li>
                        <li><a class="menu-item" href="#"><i class="material-icons"></i><span data-i18n="Content Det. Sidebar">Content Det. Sidebar</span></a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-content-detached-right-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached right sidebar">Detached right sidebar</span></a>
                                </li>
                                <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-content-detached-right-sticky-sidebar.html"><i class="material-icons"></i><span data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-fixed-navbar.html"><i class="material-icons"></i><span data-i18n="Fixed navbar">Fixed navbar</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-fixed-navigation.html"><i class="material-icons"></i><span data-i18n="Fixed navigation">Fixed navigation</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-fixed-navbar-navigation.html"><i class="material-icons"></i><span data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-fixed-navbar-footer.html"><i class="material-icons"></i><span data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</span></a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-fixed.html"><i class="material-icons"></i><span data-i18n="Fixed layout">Fixed layout</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-boxed.html"><i class="material-icons"></i><span data-i18n="Boxed layout">Boxed layout</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-static.html"><i class="material-icons"></i><span data-i18n="Static layout">Static layout</span></a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-light.html"><i class="material-icons"></i><span data-i18n="Light layout">Light layout</span></a>
                        </li>
                        <li><a class="menu-item" href="../../../starter-kit/ltr/material-vertical-content-menu-template/layout-dark.html"><i class="material-icons"></i><span data-i18n="Dark layout">Dark layout</span></a>
                        </li>
                    </ul>
                </li>
